      ...
      <Wrapper>
        ...
        <ul className="grid md:grid-cols-2 xl:grid-cols-3 gap-12">
          ...
          <li className="bg-purple-100 p-12">
            ...
            <p className="md:text-lg">Als onderdeel van de studiekeuzecheck moesten we in groepsverband werken aan een oplossing op het vraagstuk: "Amsterdam moet in 2025 volledig autovrij zijn". </p>
          </li>
        </ul>
      </Wrapper>
    </main>
