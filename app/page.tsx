      ...
      <Wrapper>
        ...
        <div className="relative max-w-4xl md:mx-14 mb-24 md:mb-40">
          <Image
              ...
              priority
            />
            <div className="md:absolute md:bottom-0 right-0 xl:translate-x-1/4 md:translate-y-1/4 md:h-80 md:w-80 md:bg-white pt-4 md:p-14 md:flex justify-center items-center md:rounded-full font-light text-lg">
        ...
        <ul className="grid md:grid-cols-2 xl:grid-cols-3 gap-12">
          <li className="bg-stone-100 p-8 md:p-12 flex flex-col justify-end">
          ...
          <li className="bg-purple-100 p-8 md:p-12">
